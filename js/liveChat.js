...
// } else {
	...
	center.id = 2;
	center.scr = '1';
	center.inner = '<a href="javascript:void(0);" onclick="openChat();" target="_blank"><img src="'+base_url+'images/liveChat/chat-center-new.gif" style="width:300px !important; top:expression(eval(document.documentElement.scrollTop))" /></a>';

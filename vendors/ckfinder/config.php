...
//     case "localhost":
//         $serverRootIndex    = ($_SERVER['DOCUMENT_ROOT'].'/http://localhost/gracia-ci/index.php');
//         $ckFinderRootPath   = ($_SERVER['DOCUMENT_ROOT'].'/http://localhost/gracia-ci/vendors/uploads');
//         break;
// }

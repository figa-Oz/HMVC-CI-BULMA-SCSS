...
$config = array(
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST']. '/gracia',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	// 'upload_dir' => '/gracia-ci/vendors/uploads/',
	'upload_dir' => '/vendors/uploads/',

	// 'upload_dir' => getenv('APP_ROOT_PATH').'/vendors/source/',
	/*
	|--------------------------------------------------------------------------

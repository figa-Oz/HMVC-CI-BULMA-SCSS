...
.focus .hd ul li{ display:inline-block; width:5px; height:5px; -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; background:#CCCCCC; margin:0 5px;  vertical-align:top; overflow:hidden;}
.focus .hd ul .on{ background:#046f50;}
...
<li><a class="chat" id="lj" href="javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-1.jpg"  /></a></li>
<li><a class="chat" href="javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-2.jpg" /></a></li>
<li><a class="chat" id="lj\" href=\"javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-3.jpg"  /></a></li>
<li><a class="chat" href="javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-4.jpg" /></a></li>
</ul>
</div>
</div>

...
<li><a id="lj" href="javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-1.jpg"  /></a></li>
<li><a href="javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-2.jpg" /></a></li>
<li><a id="lj\" href=\"javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-3.jpg"  /></a></li>
<li><a href="javascript:void(0)" onclick="onKST();" target="_blank" ><img src="<?php echo base_url() ?>images/frontend/slider/Slide-4.jpg" /></a></li>
</ul>
</div>
</div>

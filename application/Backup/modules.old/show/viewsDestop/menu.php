...
<table id="menu" class="has-background-danger">
  <tr>
    <td class="has-text-centered is-size-7-mobile" onclick="window.location.href = '<?php echo base_url('home'); ?>'"><a href="<?php echo base_url('home'); ?>">Home</a></td>
